namespace redroguecs {
	...
	public class Library {
		...
		public static readonly string pathh = "/Application/src/";
		...
		public readonly string BannerB = pathh + "assets/banner.png";
		public readonly string BannerFailB = pathh + "assets/banner-fail.png";
		public readonly string BannerCompleteB = pathh + "assets/banner-complete.png";
