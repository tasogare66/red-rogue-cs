...
namespace com.robotacid.ui.menu {
	 ...
	 */
	public class InventoryMenuList : MenuList{
		...
		public MenuList runesList;
		public MenuList heartsList;
		
		public MenuList weaponActionList;
		public MenuList armourActionList;
		public MenuList runeActionList;
		public MenuList heartActionList;
///		public EnchantmentList enchantmentList;
		
		public MenuList enchantableList;
		public MenuList enchantableWeaponsList;
		public MenuList enchantableArmourList;
		
		public MenuOption weaponsOption;
		public MenuOption armourOption;
		public MenuOption runesOption;
		public MenuOption heartsOption;
		public MenuOption autoSortOption;
		
		public ToggleMenuOption equipOption;
		public ToggleMenuOption equipMinionOption;
		public ToggleMenuOption equipMainOption;
		public ToggleMenuOption equipMinionMainOption;
		public ToggleMenuOption equipThrowOption;
		public ToggleMenuOption equipMinionThrowOption;
		public MenuOption dropOption;
		public MenuOption eatOption;
		public MenuOption feedMinionOption;
		public MenuOption enchantOption;
		public MenuOption throwRuneOption;
		public MenuOption enchantmentsOption;
		public MenuOption enchantableWeaponsOption;
		public MenuOption enchantableArmourOption;
		
///		public Dictionary itemToOption;
///		public Dictionary enchantableToOption;
		
		public const int EQUIP = 0;
		public const int UNEQUIP = 1;
		
		public const int SELECTION_STEP = 3;
		
		public InventoryMenuList(Menu menu, Game game) {
			//super();
			this.menu = menu;
			this.game = game;
...
///			enchantmentList = new EnchantmentList();
			...
			equipMainOption = new ToggleMenuOption(new Array<String>{"equip main", "unequip main"});
			equipMainOption.selectionStep = SELECTION_STEP;
			equipThrowOption = new ToggleMenuOption(new Array<String>{"equip throw", "unequip throw"});
			equipThrowOption.selectionStep = SELECTION_STEP;
			equipMinionMainOption = new ToggleMenuOption(new Array<String>{"equip minion main", "unequip minion main"});
			equipMinionMainOption.selectionStep = SELECTION_STEP;
			equipMinionThrowOption = new ToggleMenuOption(new Array<String>{"equip minion throw", "unequip minion throw"});
			equipMinionThrowOption.selectionStep = SELECTION_STEP;
			equipOption = new ToggleMenuOption(new Array<String>{"equip", "unequip"});
			equipOption.selectionStep = SELECTION_STEP;
			equipMinionOption = new ToggleMenuOption(new Array<String>{"equip minion", "unequip minion"});
...
///			enchantableToOption = new Dictionary(true);
...
#if false
		public Item addItem(Item item, Boolean visited = false){
...
#if false
		public Item addItemFromXML(XML itemXML, Boolean print = false){
		...
		public Item getItem(int name, int type){
		...
		private double weaponSortCallback(MenuOption a, MenuOption b){
		...
		private double getArmourValue(Item item){
