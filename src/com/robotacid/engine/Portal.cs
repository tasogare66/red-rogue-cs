...
///		private Character clone;
		...
		// types
		public const int STAIRS = 0;
		public const int PORTAL = 1;
		public const int MONSTER = 2;
		public const int ENDING = 3;
		public const int MINION = 4;
		
		public const int OPEN_CLOSE_DELAY = 8;
		public const double SCALE_STEP = 1.0d / OPEN_CLOSE_DELAY;
		public const double GFX_STEP = (SCALE * 0.5d) / OPEN_CLOSE_DELAY;
		public const int CLONE_ENTRY_DELAY = 8;
		public const double UNDEAD_HEAL_RATE = 0.05d;
		...
		public static string usageMsg(int type, int targetLevel, int targetType){
